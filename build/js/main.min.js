...
var $menu = $('.j-mm-navi');
var $isnavi = $('body');
var $mnavitoggle = $('.j-mobile-toggle'); // show modal alert
...
$(document).on("scroll", function () {
  var scroll = $(window).scrollTop(); // var height = $(window).height();
...
var $mdropdown = $('.mobile-dropdown');
var mtoggle = $('.j-mm-togle');
$(document).mouseup(function (e) {
...
$('.j-mm-togle').click(function (e) {
  e.preventDefault();
  var mdropdown = $(this).data('toggle'); // $('.mobile-dropdown').removeClass('active');
...
$(".j-tabs-container").on("click", ".j-mt-btn:not(.active)", function () {
  ...
  $(this).parent().scrollLeft(scrollTo);
  $(this).addClass("active").siblings().removeClass("active").closest(".j-tabs-container").find(".tab").removeClass("active").eq($(this).index()).addClass("active");
});
appendNavi();
...
var myReviewsSwiper = new Swiper('.reviews-slider', (_Swiper = {
  loop: true,
  mode: 'horizontal',
  autoHeight: true,
  effect: 'fade',
  ...
  delay: 5000
}), _defineProperty(_Swiper, "updateOnWindowResize", true), _defineProperty(_Swiper, "pagination", {
...
var pcElem = 0;
document.querySelectorAll('.j-pc-branch').forEach(function (n) {
...
var jtabsElem = 0;
document.querySelectorAll('.j-tabs-slider').forEach(function (n) {
...
$(document).ready(function () {
  $('.hc-menu').mousemove(function (e) {
    ...
    var diff = Xinner - Yinner; //  console.log("X: " + Xinner + " Y: " + Yinner + "------pos left:" + elem_left + "pos_top:" + elem_top ); // вывод результата в консоль
...
var sl = $('.j-stuff-slider'); // const ppsl = $('.j-pp-slick');
...
(function () {
  ...
  var mySwiper;
  var myPremsSwiper;
  var myReturnSwiper; //   let myStuffSwiper;
  ...
  var breakpointChecker = function breakpointChecker() {
    ...
    if (breakpoint.matches === true) {
      ...
      enableSwiper();
      enablePremsSwiper();
      enableReturnSwiper(); //   enableStuffSwiper();
    }
  };
  ...
  var enablePremsSwiper = function enablePremsSwiper() {
    document.querySelectorAll('.j-pp-slider').forEach(function (n) {
  ...
  var enableReturnSwiper = function enableReturnSwiper() {
    document.querySelectorAll('.j-return-slider').forEach(function (n) {
...
function responseMenu() {
  ...
  if (hide_from <= items.length - 1) {
    items.eq(hide_from).nextAll('li.item').appendTo('ul.dropdown-menu'); //   items.css({'width':(max_width / (hide_from + 1)) + 'px'});
